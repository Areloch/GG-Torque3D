...
public:
   ...
   //override to pass back a TriggerComponentInstance
   virtual ComponentInstance *createInstance();
};

class TriggerComponentInstance : public ComponentInstance
{
...
public:
   TriggerComponentInstance(Component *btemplate = NULL);
   virtual ~TriggerComponentInstance();
   DECLARE_CONOBJECT(TriggerComponentInstance);
