...
singleton Material(LMX_chapel_props_chapel_Module_Common_LMX_chapel_props_Material0)
{
   ...
   specularMap[0] = "art/shapes/yorks/chapel/brick_block.png";
...
singleton Material(LMX_chapel_props1_chapel_Module_Common_LMX_chapel_props_Material1_003)
{
   mapTo = "chapel_Module_Common_LMX_chapel_props-Material1.003";
   diffuseColor[0] = "1 1 1 1";
   specular[0] = "0.5 0.5 0.5 1";
   specularPower[0] = "1";
   translucentBlendOp = "None";
   diffuseMap[0] = "art/shapes/yorks/chapel/marble1_green.png";
   toneMap[0] = "art/shapes/yorks/chapel/Module_Common/LMX_chapel_props.png";
   pixelSpecular[0] = "1";
};

singleton Material(LMX_chapel_props1_chapel_Module_Common_LMX_chapel_props_Material2_003)
{
   mapTo = "chapel_Module_Common_LMX_chapel_props-Material2.003";
   diffuseColor[0] = "1 1 1 1";
   specular[0] = "0.5 0.5 0.5 1";
   specularPower[0] = "1";
   translucentBlendOp = "None";
...
singleton Material(LMX_chapel_props1_chapel_Module_Common_LMX_chapel_props_Material0_003)
{
   mapTo = "chapel_Module_Common_LMX_chapel_props-Material0.003";
   diffuseColor[0] = "1 1 1 1";
   specular[0] = "0.5 0.5 0.5 1";
   specularPower[0] = "1";
   translucentBlendOp = "None";
